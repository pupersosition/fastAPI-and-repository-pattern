...
def create_session(MAX_ATTEMPTS: int, SLEEP_INTERVAL: int, DB_USER: str, DB_PASS:str, DB_HOST: str, DB_NAME: str) -> Session:
...
@contextmanager
def session_scope(MAX_ATTEMPTS: int, SLEEP_INTERVAL: int, DB_USER: str, DB_PASS:str, DB_HOST: str, DB_NAME: str) -> Generator[Session, None, None]:
